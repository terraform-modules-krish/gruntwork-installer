...
gruntwork-install --module-name "dummy-module" --repo "https://github.com/terraform-modules-krish/gruntwork-installer" --branch "fix-args" --module-param "file-to-cat=$SCRIPT_DIR/integration-test.sh"
