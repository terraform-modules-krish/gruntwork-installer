...
gruntwork-install --module-name "dummy-module" --repo "https://github.com/terraform-modules-krish/gruntwork-installer" --tag "v0.0.17" --module-param "file-to-cat=$SCRIPT_DIR/integration-test.sh"
...
gruntwork-install --repo 'https://github.com/terraform-modules-krish/terragrunt' --binary-name terragrunt --tag '~>v0.18.4'
