...
```
curl -LsS https://raw.githubusercontent.com/terraform-modules-krish/gruntwork-installer/master/bootstrap-gruntwork-installer.sh | bash /dev/stdin --version v0.0.22
```
...
module](https://github.com/terraform-modules-krish/terraform-aws-ecs/tree/master/modules/ecs-scripts) from the [terraform-aws-ecs
...
module](https://github.com/terraform-modules-krish/terraform-aws-security/tree/master/modules/fail2ban) from the [terraform-aws-security
...
module](https://github.com/terraform-modules-krish/terraform-aws-ecs/tree/master/modules/ecs-scripts) as follows:
