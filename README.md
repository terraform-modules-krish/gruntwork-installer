...
```bash
curl -Ls https://raw.githubusercontent.com/terraform-modules-krish/gruntwork-installer/master/bootstrap-gruntwork-installer.sh | bash -s --version 0.0.1
```

Notice the `--version` parameter at the end where you specify which version of `gruntwork-install` to install. See the
[releases](https://github.com/terraform-modules-krish/gruntwork-installer/blob/0.0.1/releases) page for all available versions.
...
```json
{
  ...
  "provisioners": [{
    "type": "shell",
    "inline": "curl -Ls https://raw.githubusercontent.com/terraform-modules-krish/gruntwork-installer/master/bootstrap-gruntwork-installer.sh | bash -s --version 0.0.1"
  },{
    "type": "shell",
    "inline": [
